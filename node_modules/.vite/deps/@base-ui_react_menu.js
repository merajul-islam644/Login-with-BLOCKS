  ...
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      function useSyncExternalStore$2(subscribe, getSnapshot) {
        didWarnOld18Alpha || void 0 === React78.startTransition || (didWarnOld18Alpha = true, console.error(
      ...
      var React78 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState21 = React78.useState, useEffect16 = React78.useEffect, useLayoutEffect2 = React78.useLayoutEffect, useDebugValue2 = React78.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
      exports.useSyncExternalStore = void 0 !== React78.useSyncExternalStore ? React78.useSyncExternalStore : shim;
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React78 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore2 = shim.useSyncExternalStore, useRef38 = React78.useRef, useEffect16 = React78.useEffect, useMemo29 = React78.useMemo, useDebugValue2 = React78.useDebugValue;
...
var MenuCheckboxItemContext = React7.createContext(void 0);
if (true) MenuCheckboxItemContext.displayName = "MenuCheckboxItemContext";
function useMenuCheckboxItemContext() {
  const context = React7.useContext(MenuCheckboxItemContext);
  if (context === void 0) {
...
function useMenuItem(params) {
  ...
  const getItemProps = React9.useCallback((externalProps) => {
...
var CompositeListContext = React10.createContext({
  register: () => {
  },
  unregister: () => {
  },
...
function useCompositeListItem(params = {}) {
  ...
  const indexRef = React11.useRef(-1);
  const [index2, setIndex] = React11.useState(externalIndex ?? (indexGuessBehavior === IndexGuessBehavior.GuessFromOrder ? () => {
  ...
  const ref = React11.useCallback((node) => {
    ...
    if (index2 !== -1 && node !== null) {
      ...
      if (labelsRef) {
        ...
        labelsRef.current[index2] = isLabelDefined ? label : ((_a2 = textRef == null ? void 0 : textRef.current) == null ? void 0 : _a2.textContent) ?? node.textContent;
      }
    }
  ...
  useIsoLayoutEffect(() => {
    ...
    return subscribeMapChange((map) => {
      var _a2;
      const i = componentRef.current ? (_a2 = map.get(componentRef.current)) == null ? void 0 : _a2.index : null;
      if (i != null) {
        setIndex(i);
      }
    });
...
var MenuCheckboxItem = React13.forwardRef(function MenuCheckboxItem2(componentProps, forwardedRef) {
  const {
    render,
    className,
    id: idProp,
...
var MenuCheckboxItemIndicator = React14.forwardRef(function MenuCheckboxItemIndicator2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
  ...
  const indicatorRef = React14.useRef(null);
  const {
    transitionStatus,
    setMounted
...
var MenuGroupContext = React15.createContext(void 0);
if (true) MenuGroupContext.displayName = "MenuGroupContext";
function useMenuGroupRootContext() {
  const context = React15.useContext(MenuGroupContext);
  if (context === void 0) {
...
var MenuGroup = React16.forwardRef(function MenuGroup2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
  ...
  const [labelId, setLabelId] = React16.useState(void 0);
  const element = useRenderElement("div", componentProps, {
    ref: forwardedRef,
    props: {
      role: "group",
...
var MenuGroupLabel = React17.forwardRef(function MenuGroupLabel2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
...
var MenuItem = React18.forwardRef(function MenuItem2(componentProps, forwardedRef) {
  const {
    render,
    className,
    id: idProp,
...
var MenuLinkItem = React19.forwardRef(function MenuLinkItem2(componentProps, forwardedRef) {
  const {
    render,
    className,
    id: idProp,
...
var FocusGuard = React21.forwardRef(function FocusGuard2(props, ref) {
...
function isListIndexDisabled(list, index2, disabledIndices) {
  const isExplicitlyDisabled = typeof disabledIndices === "function" ? disabledIndices(index2) : (disabledIndices == null ? void 0 : disabledIndices.includes(index2)) ?? false;
...
var PortalContext = React22.createContext(null);
...
var FloatingPortal = React22.forwardRef(function FloatingPortal2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
  ...
  return (0, import_jsx_runtime5.jsxs)(React22.Fragment, {
    children: [portalSubtree, (0, import_jsx_runtime5.jsxs)(PortalContext.Provider, {
      value: portalContextValue,
      children: [shouldRenderGuards && portalNode && (0, import_jsx_runtime5.jsx)(FocusGuard, {
        "data-type": "outside",
      ...
      }), shouldRenderGuards && portalNode && (0, import_jsx_runtime5.jsx)("span", {
        "aria-owns": portalNode.id,
        style: ownerVisuallyHidden
      }), portalNode && ReactDOM.createPortal(children, portalNode), shouldRenderGuards && portalNode && (0, import_jsx_runtime5.jsx)(FocusGuard, {
        "data-type": "outside",
        ref: afterOutsideRef,
        onFocus: (event) => {
          var _a2;
...
var FloatingNodeContext = React23.createContext(null);
if (true) FloatingNodeContext.displayName = "FloatingNodeContext";
var FloatingTreeContext = React23.createContext(null);
if (true) FloatingTreeContext.displayName = "FloatingTreeContext";
var useFloatingParentNodeId = () => {
  var _a2;
  return ((_a2 = React23.useContext(FloatingNodeContext)) == null ? void 0 : _a2.id) || null;
};
...
function FloatingNode(props) {
  ...
  const parentId = useFloatingParentNodeId();
  return (0, import_jsx_runtime6.jsx)(FloatingNodeContext.Provider, {
...
function FloatingTree(props) {
  ...
  return (0, import_jsx_runtime6.jsx)(FloatingTreeContext.Provider, {
    value: tree,
    children
  });
}
...
function FloatingFocusManager(props) {
  ...
  return (0, import_jsx_runtime7.jsxs)(React24.Fragment, {
    children: [shouldRenderGuards && (0, import_jsx_runtime7.jsx)(FocusGuard, {
      "data-type": "inside",
...
// node_modules/@base-ui/utils/store/createSelectorMemoized.mjs
...
function fastComponentRef(fn) {
  return React30.forwardRef(fastComponent(fn));
}
...
// node_modules/@base-ui/utils/store/StoreInspector.mjs
...
function useTriggerRegistration(id, store) {
  const registeredElementIdRef = React36.useRef(null);
  const registeredElementRef = React36.useRef(null);
  return React36.useCallback((element) => {
    if (id === void 0) {
      return;
    }
...
var popupIdSelector = createSelector((state) => {
  var _a2;
  const popupId = ((_a2 = state.popupElement) == null ? void 0 : _a2.id) ?? state.floatingId;
    ...
    return {
      ...
      onBlur(event) {
        ...
        timeout.start(0, () => {
          ...
          if (contains((_a2 = dataRef.current.floatingContext) == null ? void 0 : _a2.refs.floating.current, activeEl) || contains(domReference, activeEl) || movedToFocusGuard) {
            return;
          }
...
function clearSafePolygonPointerEventsMutation(instance) {
  ...
  if (scopeElement && pointerEventsMutationOwnerByScopeElement.get(scopeElement) === instance) {
    (_a2 = instance.pointerEventsScopeElement) == null ? void 0 : _a2.style.removeProperty("pointer-events");
...
function useHoverFloatingInteraction(context, parameters = {}) {
  ...
  const isHoverOpen = useStableCallback(() => {
    var _a2;
    return isHoverOpenEvent((_a2 = dataRef.current.openEvent) == null ? void 0 : _a2.type);
  });
  ...
  useIsoLayoutEffect(() => {
    ...
    if (open && ((_a2 = instance.handleCloseOptions) == null ? void 0 : _a2.blockPointerEvents) && isHoverOpen() && isElement(domReferenceElement) && floatingElement) {
  ...
  React39.useEffect(() => {
    ...
    function onFloatingMouseLeave(event) {
      ...
      const currentNodeId = ((_a2 = dataRef.current.floatingContext) == null ? void 0 : _a2.nodeId) ?? nodeIdProp;
      const relatedTarget = event.relatedTarget;
      const isMovingIntoDescendantFloating = tree && currentNodeId && isElement(relatedTarget) && getNodeChildren(tree.nodesRef.current, currentNodeId, false).some((node) => {
        var _a3;
        return contains((_a3 = node.context) == null ? void 0 : _a3.elements.floating, relatedTarget);
      });
...
function useHoverReferenceInteraction(context, props = {}) {
  ...
  const isClickLikeOpenEvent2 = useStableCallback(() => {
    var _a3;
    return isClickLikeOpenEvent((_a3 = dataRef.current.openEvent) == null ? void 0 : _a3.type, instance.interactedInside);
  });
  const checkShouldOpen = useStableCallback(() => {
    var _a3;
    return ((_a3 = shouldOpenRef.current) == null ? void 0 : _a3.call(shouldOpenRef)) !== false;
  });
  ...
  if (isActiveTrigger) {
    instance.handleCloseOptions = (_a2 = handleCloseRef.current) == null ? void 0 : _a2.__options;
  }
  ...
  React40.useEffect(() => {
    ...
    function onMouseEnter(event) {
      ...
      const isInClosingTransition = ((_a3 = isClosingRef.current) == null ? void 0 : _a3.call(isClosingRef)) ?? store.select("transitionStatus") === "ending";
  ...
  return React40.useMemo(() => {
    ...
    return {
      ...
      onMouseMove(event) {
        ...
        if (currentOpen && isOverInactive && ((_a3 = instance.handleCloseOptions) == null ? void 0 : _a3.blockPointerEvents)) {
...
// node_modules/@base-ui/react/floating-ui-react/hooks/useHover.mjs
...
function useListNavigation(context, props) {
  ...
  const parentId = useFloatingParentNodeId();
  const tree = useFloatingTree(externalTree);
  const focusItemOnOpenRef = React42.useRef(focusItemOnOpen);
  const indexRef = React42.useRef(selectedIndex ?? -1);
  const keyRef = React42.useRef(null);
  const isPointerModalityRef = React42.useRef(true);
  const onNavigate = useStableCallback((event) => {
    onNavigateProp(indexRef.current === -1 ? null : indexRef.current, event);
  });
  const previousMountedRef = React42.useRef(!!floatingElement);
  const previousOpenRef = React42.useRef(open);
  const forceSyncFocusRef = React42.useRef(false);
  const forceScrollIntoViewRef = React42.useRef(false);
  const cancelQueuedFocusRef = React42.useRef(null);
  ...
  const ariaActiveDescendantProp = React42.useMemo(() => {
    return virtual && open && hasActiveIndex && {
      "aria-activedescendant": `${id}-${activeIndex}`
    };
  }, [virtual, open, hasActiveIndex, id, activeIndex]);
  const floating = React42.useMemo(() => {
    return {
  ...
  const reference = React42.useMemo(() => {
    return {
...
function useTypeahead(context, props) {
  ...
  const open = store.useState("open");
  const timeout = useTimeout();
  const stringRef = React43.useRef("");
  const prevIndexRef = React43.useRef(selectedIndex ?? activeIndex ?? -1);
  const matchIndexRef = React43.useRef(null);
  const onKeyDown = useStableCallback((event) => {
    ...
    function getMatchingIndex(list, string, startIndex2 = 0) {
      ...
      for (let offset4 = 0; offset4 < list.length; offset4 += 1) {
        ...
        if (!(text == null ? void 0 : text.toLowerCase().startsWith(lowerString)) || !isItemAvailable(index3)) {
          continue;
        }
        return index3;
      }
    ...
    const allowRapidSuccessionOfFirstLetter = listContent.every((text, index3) => {
      var _a2, _b;
      return text && isItemAvailable(index3) ? ((_a2 = text[0]) == null ? void 0 : _a2.toLowerCase()) !== ((_b = text[1]) == null ? void 0 : _b.toLowerCase()) : true;
    });
  ...
  const sharedProps = React43.useMemo(() => ({
    onKeyDown,
    onBlur
  }), [onKeyDown, onBlur]);
...
var ToolbarRootContext = React44.createContext(void 0);
if (true) ToolbarRootContext.displayName = "ToolbarRootContext";
function useToolbarRootContext(optional) {
  const context = React44.useContext(ToolbarRootContext);
  if (context === void 0 && !optional) {
...
var MenuPopup = React45.forwardRef(function MenuPopup2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
  ...
  const setPopupElement = React45.useCallback((element2) => {
  ...
  return (0, import_jsx_runtime9.jsx)(FloatingFocusManager, {
...
var MenuPortalContext = React46.createContext(void 0);
if (true) MenuPortalContext.displayName = "MenuPortalContext";
function useMenuPortalContext() {
  const value = React46.useContext(MenuPortalContext);
  if (value === void 0) {
...
var MenuPortal = React47.forwardRef(function MenuPortal2(props, forwardedRef) {
  const {
    keepMounted = false,
    ...portalProps
  } = props;
  ...
  return (0, import_jsx_runtime10.jsx)(MenuPortalContext.Provider, {
    value: keepMounted,
    children: (0, import_jsx_runtime10.jsx)(FloatingPortal, {
      ref: forwardedRef,
      ...portalProps
    })
  });
...
function useDirection() {
  const context = React48.useContext(DirectionContext);
...
var baseArrow = (options) => ({
  ...
  async fn(state) {
    ...
    const arrowOffsetParent = offsetParent === "real" ? await ((_a2 = platform3.getOffsetParent) == null ? void 0 : _a2.call(platform3, element)) : elements.floating;
    let clientSize = elements.floating[clientProp] || rects.floating[length];
    if (!clientSize || !await ((_b = platform3.isElement) == null ? void 0 : _b.call(platform3, arrowOffsetParent))) {
...
var adaptiveOrigin = {
  ...
  async fn(state) {
    ...
    const offsetParent = await ((_a2 = platform3.getOffsetParent) == null ? void 0 : _a2.call(platform3, floating));
    ...
    } else if (await ((_b = platform3.isElement) == null ? void 0 : _b.call(platform3, offsetParent))) {
...
function useAnchorPositioning(params) {
  ...
  const [mountSide, setMountSide] = React49.useState(null);
  ...
  const autoUpdateOptions = React49.useMemo(() => ({
  ...
  const registeredPositionReferenceRef = React49.useRef(null);
  useIsoLayoutEffect(() => {
    if (!mounted) {
      return;
    }
  ...
  const arrowStyles = React49.useMemo(() => {
    var _a3, _b2;
    return {
      position: "absolute",
...
function CompositeList(props) {
  ...
  return (0, import_jsx_runtime11.jsx)(CompositeListContext.Provider, {
    value: contextValue,
    children
  });
}
...
function preventScrollInsetScrollbars(referenceElement) {
  ...
  if (parts_exports.engine.webkit && (((_a2 = win.visualViewport) == null ? void 0 : _a2.scale) ?? 1) !== 1) {
    return () => {
    };
  }
  function lockScroll() {
...
var MenuPositioner = React53.forwardRef(function MenuPositioner2(componentProps, forwardedRef) {
  var _a2;
  const {
    anchor: anchorProp,
  ...
  const previousTriggerRef = React53.useRef(null);
  ...
  return (0, import_jsx_runtime13.jsxs)(MenuPositionerContext.Provider, {
    value: positioner,
    children: [shouldRenderBackdrop && (0, import_jsx_runtime13.jsx)(InternalBackdrop, {
      ref: parent.type === "context-menu" || parent.type === "nested-context-menu" ? parent.context.internalBackdropRef : null,
      inert: inertValue(!open),
      cutout: backdropCutout
    }), (0, import_jsx_runtime13.jsx)(FloatingNode, {
      id: floatingNodeId,
      children: (0, import_jsx_runtime13.jsx)(CompositeList, {
...
var MenuRadioGroupContext = React54.createContext(void 0);
if (true) MenuRadioGroupContext.displayName = "MenuRadioGroupContext";
function useMenuRadioGroupContext() {
  const context = React54.useContext(MenuRadioGroupContext);
  if (context === void 0) {
...
var MenuRadioGroup = React55.memo(React55.forwardRef(function MenuRadioGroup2(componentProps, forwardedRef) {
  const {
    render,
    className,
    value: valueProp,
  ...
  const [labelId, setLabelId] = React55.useState(void 0);
  ...
  return (0, import_jsx_runtime14.jsx)(MenuGroupContext.Provider, {
    value: setLabelId,
    children: (0, import_jsx_runtime14.jsx)(MenuRadioGroupContext.Provider, {
      value: context,
      children: element
    })
  });
...
var MenuRadioItemContext = React56.createContext(void 0);
if (true) MenuRadioItemContext.displayName = "MenuRadioItemContext";
function useMenuRadioItemContext() {
  const context = React56.useContext(MenuRadioItemContext);
  if (context === void 0) {
...
var MenuRadioItem = React57.forwardRef(function MenuRadioItem2(componentProps, forwardedRef) {
  const {
    render,
    className,
    id: idProp,
  ...
  return (0, import_jsx_runtime15.jsx)(MenuRadioItemContext.Provider, {
    value: state,
    children: element
  });
});
...
var MenuRadioItemIndicator = React58.forwardRef(function MenuRadioItemIndicator2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
  ...
  const indicatorRef = React58.useRef(null);
  const {
    transitionStatus,
    setMounted
  } = useTransitionStatus(item.checked);
...
var MenubarContext = React59.createContext(null);
if (true) MenubarContext.displayName = "MenubarContext";
function useMenubarContext(optional) {
  const context = React59.useContext(MenubarContext);
...
function useEnhancedClickHandler(handler) {
  const lastClickInteractionTypeRef = React60.useRef("");
  const handlePointerDown = React60.useCallback((event) => {
...
function useValueChanged(value, onChange) {
  const valueRef = React61.useRef(value);
...
function useOpenInteractionType(open) {
  const [openMethod, setOpenMethod] = React62.useState(null);
...
var MenuStore = class _MenuStore extends ReactStore {
  constructor(initialState) {
    super({
      ...
      positionerRef: React63.createRef(),
      popupRef: React63.createRef(),
      typingRef: {
        current: false
      },
      itemDomElements: {
      ...
      triggerFocusTargetRef: React63.createRef(),
      beforeContentFocusGuardRef: React63.createRef(),
...
var MenuSubmenuRootContext = React64.createContext(void 0);
if (true) MenuSubmenuRootContext.displayName = "MenuSubmenuRootContext";
function useMenuSubmenuRootContext() {
  return React64.useContext(MenuSubmenuRootContext);
}
...
var MenuRoot = fastComponent(function MenuRoot2(props) {
  ...
  const parentFromContext = React65.useMemo(() => {
  ...
  const floatingParentNodeId = store.useState("floatingParentNodeId");
  const openEventRef = React65.useRef(null);
  const allowOutsidePressDismissalRef = React65.useRef(parent.type !== "context-menu");
  const allowOutsidePressDismissalTimeout = useTimeout();
  const allowTouchToCloseRef = React65.useRef(true);
  ...
  React65.useImperativeHandle(ctx == null ? void 0 : ctx.positionerRef, () => positionerElement, [positionerElement]);
  React65.useImperativeHandle(ctx == null ? void 0 : ctx.actionsRef, () => ({
    setOpen
  }), [setOpen]);
  const dismiss = useDismiss(floatingRootContext, {
    ...
    outsidePress() {
      var _a2;
      if (parent.type !== "context-menu" || ((_a2 = openEventRef.current) == null ? void 0 : _a2.type) === "contextmenu") {
        return true;
      }
  ...
  const direction = useDirection();
  const setActiveIndex = React65.useCallback((index2) => {
  ...
  const onTyping = React65.useCallback((nextTyping) => {
  ...
  const activeTriggerProps = React65.useMemo(() => {
  ...
  const inactiveTriggerProps = React65.useMemo(() => {
  ...
  const popupProps = React65.useMemo(() => mergeProps(FOCUSABLE_POPUP_PROPS, {
    id: floatingId,
    role: "menu",
  ...
  const content = (0, import_jsx_runtime16.jsx)(MenuRootContext.Provider, {
    value: context,
  ...
  if (parent.type === void 0 || parent.type === "context-menu") {
    return (0, import_jsx_runtime16.jsx)(FloatingTree, {
      externalTree: floatingTreeRoot,
      children: content
    });
  }
...
function MenuSubmenuRoot(props) {
  ...
  return (0, import_jsx_runtime17.jsx)(MenuSubmenuRootContext.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime17.jsx)(MenuRoot, {
      ...props
    })
  });
}
...
function useTriggerFocusGuards(store, triggerElementRef) {
  const preFocusGuardRef = React68.useRef(null);
...
function useMixedToggleClickHandler(params) {
  ...
  const ignoreClickRef = React69.useRef(false);
...
var MenuTrigger = fastComponentRef(function MenuTrigger2(componentProps, forwardedRef) {
  ...
  const triggerElementRef = React70.useRef(null);
  const parent = useMenuParent();
  const compositeRootContext = useCompositeRootContext(true);
  const floatingTreeRootFromContext = useFloatingTree();
  const floatingTreeRoot = React70.useMemo(() => {
  ...
  const localInteractionProps = React70.useMemo(() => mergeProps(focus.reference, click.reference), [focus.reference, click.reference]);
  ...
  if (isInMenubar) {
    return (0, import_jsx_runtime18.jsx)(CompositeItem, {
      tag: "button",
      render,
      className,
      style,
  ...
  if (isOpenedByThisTrigger) {
    return (0, import_jsx_runtime18.jsxs)(React70.Fragment, {
      children: [(0, import_jsx_runtime18.jsx)(FocusGuard, {
        ref: preFocusGuardRef,
        onFocus: handlePreFocusGuardFocus
      }, `${thisTriggerId}-pre-focus-guard`), (0, import_jsx_runtime18.jsx)(React70.Fragment, {
        children: element
      }, thisTriggerId), (0, import_jsx_runtime18.jsx)(FocusGuard, {
        ref: store.context.triggerFocusTargetRef,
        onFocus: handleFocusTargetFocus
      }, `${thisTriggerId}-post-focus-guard`)]
    });
  }
  return (0, import_jsx_runtime18.jsx)(React70.Fragment, {
    children: element
  }, thisTriggerId);
});
...
function useStickIfOpen(open, openReason) {
  ...
  const [stickIfOpen, setStickIfOpen] = React70.useState(false);
  useIsoLayoutEffect(() => {
...
function usePopupAutoResize(parameters) {
  ...
  const committedDimensionsRef = React72.useRef(null);
  const isInitialRenderRef = React72.useRef(true);
  const restoreAnchoringStylesRef = React72.useRef(NOOP);
  const onMeasureLayout = useStableCallback(onMeasureLayoutParam);
  const onMeasureLayoutComplete = useStableCallback(onMeasureLayoutCompleteParam);
  const anchoringStyles = React72.useMemo(() => {
...
var DirectionProvider = function DirectionProvider2(props) {
  ...
  return (0, import_jsx_runtime19.jsx)(DirectionContext.Provider, {
    value: contextValue,
...
function usePopupViewport(parameters) {
  ...
  const capturedNodeRef = React74.useRef(null);
  const [previousContentNode, setPreviousContentNode] = React74.useState(null);
  const [newTriggerOffset, setNewTriggerOffset] = React74.useState(null);
  const currentContainerRef = React74.useRef(null);
  const previousContainerRef = React74.useRef(null);
  const onAnimationsFinished = useAnimationsFinished(currentContainerRef, true, false);
  const cleanupFrame = useAnimationFrame();
  const [previousContentDimensions, setPreviousContentDimensions] = React74.useState(null);
  const [showStartingStyleAttribute, setShowStartingStyleAttribute] = React74.useState(false);
  useIsoLayoutEffect(() => {
  ...
  const handleMeasureLayout = useStableCallback(() => {
    var _a2, _b, _c;
    (_a2 = currentContainerRef.current) == null ? void 0 : _a2.style.setProperty("animation", "none");
  ...
  const handleMeasureLayoutComplete = useStableCallback((previousDimensions) => {
    var _a2, _b, _c;
    (_a2 = currentContainerRef.current) == null ? void 0 : _a2.style.removeProperty("animation");
  ...
  const lastHandledTriggerRef = React74.useRef(null);
  useIsoLayoutEffect(() => {
    if (!open || !mounted) {
  ...
  if (!isTransitioning) {
    childrenToRender = (0, import_jsx_runtime20.jsx)("div", {
      "data-current": true,
      ref: currentContainerRef,
      children
    }, currentContentKey);
  } else {
    childrenToRender = (0, import_jsx_runtime20.jsxs)(React74.Fragment, {
      ...
      }, "previous"), (0, import_jsx_runtime20.jsx)("div", {
        "data-current": true,
        ref: currentContainerRef,
...
function usePopupContentKey(activeTriggerId, payload) {
  const [contentKey, setContentKey] = React74.useState(0);
  const previousActiveTriggerIdRef = React74.useRef(activeTriggerId);
  const previousPayloadRef = React74.useRef(payload);
  const pendingPayloadUpdateRef = React74.useRef(false);
  useIsoLayoutEffect(() => {
...
var MenuViewport = React75.forwardRef(function MenuViewport2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
...
var Separator = React76.forwardRef(function SeparatorComponent(componentProps, forwardedRef) {
  const {
    className,
    render,
...
// node_modules/@base-ui/react/menu/submenu-trigger/MenuSubmenuTrigger.mjs
var MenuSubmenuTrigger = React77.forwardRef(function MenuSubmenuTrigger2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
  ...
  const registerTrigger = React77.useCallback((element2) => {
  ...
  const handleTriggerElementRef = React77.useCallback((el) => {
  ...
  const itemMetadata = React77.useMemo(() => ({
