...
function DialogRoot(props) {
  const mode = React11.useContext(IsDrawerContext) ? "drawer" : "dialog";
...
var DialogViewport = React12.forwardRef(function DialogViewport2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
...
var DialogTitle = React13.forwardRef(function DialogTitle2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
...
var DialogTrigger = React14.forwardRef(function DialogTrigger2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
  ...
  const triggerElementRef = React14.useRef(null);
  const {
    registerTrigger,
...
//# sourceMappingURL=chunk-K4IPCLMS.js.map
